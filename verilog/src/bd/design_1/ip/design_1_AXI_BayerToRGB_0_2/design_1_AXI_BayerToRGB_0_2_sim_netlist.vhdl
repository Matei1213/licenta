...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_AXI_BayerToRGB_0_2 -prefix
--               design_1_AXI_BayerToRGB_0_2_ design_1_AXI_BayerToRGB_0_1_sim_netlist.vhdl
...
entity design_1_AXI_BayerToRGB_0_2_LineBuffer is
  port (
...
end design_1_AXI_BayerToRGB_0_2_LineBuffer;

architecture STRUCTURE of design_1_AXI_BayerToRGB_0_2_LineBuffer is
  ...
  attribute RTL_RAM_NAME of pLineBuffer_reg : label is "design_1_AXI_BayerToRGB_0_1/U0/LineBufferInst/pLineBuffer_reg";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_AXI_BayerToRGB_0_2_AXI_BayerToRGB is
  port (
...
end design_1_AXI_BayerToRGB_0_2_AXI_BayerToRGB;

architecture STRUCTURE of design_1_AXI_BayerToRGB_0_2_AXI_BayerToRGB is
  ...
  signal sLineBufferReadDataBuf_0 : STD_LOGIC_VECTOR ( 0 to 0 );
...
LineBufferInst: entity work.design_1_AXI_BayerToRGB_0_2_LineBuffer
     port map (
...
\sLineBufferReadDataBuf[9]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      O => sLineBufferReadDataBuf_0(0)
    );
\sLineBufferReadDataBuf_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => StreamClk,
      CE => sLineBufferReadDataBuf_0(0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_AXI_BayerToRGB_0_2 is
  port (
    StreamClk : in STD_LOGIC;
    sStreamReset_n : in STD_LOGIC;
    s_axis_video_tready : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_AXI_BayerToRGB_0_2 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_AXI_BayerToRGB_0_2 : entity is "design_1_AXI_BayerToRGB_0_1,AXI_BayerToRGB,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_AXI_BayerToRGB_0_2 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_AXI_BayerToRGB_0_2 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of design_1_AXI_BayerToRGB_0_2 : entity is "AXI_BayerToRGB,Vivado 2025.2";
end design_1_AXI_BayerToRGB_0_2;

architecture STRUCTURE of design_1_AXI_BayerToRGB_0_2 is
  ...
  attribute x_interface_parameter of StreamClk : signal is "XIL_INTERFACENAME AXI_Stream_Clk, ASSOCIATED_BUSIF AXI_Stream_Master:AXI_Slave_Interface, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_video_aclk, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of m_axis_video_tready : signal is "XIL_INTERFACENAME AXI_Stream_Master, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN design_1_video_aclk, LAYERED_METADATA undef, INSERT_VIP 0";
...
U0: entity work.design_1_AXI_BayerToRGB_0_2_AXI_BayerToRGB
     port map (
      StreamClk => StreamClk,
      m_axis_video_tdata(29 downto 0) => \^m_axis_video_tdata\(29 downto 0),
