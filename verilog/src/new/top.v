...
wire                            cmos_16bit_wr;
(* MARK_DEBUG = "true" *)wire[1:0]                       write_addr_index;
(* MARK_DEBUG = "true" *)wire[1:0]                       read_addr_index;
wire[9:0]                       lut_index;
wire[31:0]                      lut_data;
...
(* MARK_DEBUG = "true" *)wire[9:0]                       cmos1_lut_index;
...
assign write_en = m_axis_tvalid & m_axis_tready ;
assign write_data = m_axis_tdata;
...
//generate ddr3 clock
 ...
 (
  ...
  .clk_out2(lite_aclk),        // output clk_out1
...
rgb2dvi_m0 (
     ...
     //Auxiliary signals 
      ...
      // Video in
     .vid_pData({vout_data[15:11],3'd0,vout_data[10:5],2'd0,vout_data[4:0],3'd0}),
      .vid_pVDE(de),
      .vid_pHSync(hs),
      .vid_pVSync(vs),       
      .PixelClk(video_clk),
...
(
	...
	.read_addr_index            (read_addr_index          ),
	.read_len                   (24'd518400               ),//frame size 800 * 480 * 16 / 64
	.read_en                    (read_en                  ),
	.read_data                  (read_data                ),
	...
	.write_addr_index           (write_addr_index         ),
	.write_len                  (24'd518400               ), //frame size 800 * 480 * 16 / 64
	.write_en                   (write_en                 ),
