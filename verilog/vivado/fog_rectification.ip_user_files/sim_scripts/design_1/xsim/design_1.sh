...
#
# Script generated by Vivado on Sat May 23 14:22:18 +0300 2026
...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L mipi_dphy_v4_3_17"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axis_infrastructure_v1_1_1 -L axis_register_slice_v1_1_35 -L axis_subset_converter_v1_1_36 -L mipi_dphy_v4_3_17 -L mipi_csi2_rx_ctrl_v1_0_14 -L axis_switch_v1_1_35 -L vfb_v1_0_29 -L proc_sys_reset_v5_0_17 -L gigantic_mux -L xlconstant_v1_1_10 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_bf15.protoinst" -protoinst "protoinst_files/bd_f60c.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
